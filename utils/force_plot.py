...
from shap.common import convert_to_link, Instance, Model, Data, DenseData, Link, hclust_ordering
from shap.plots.force_matplotlib import draw_additive_plot
...
def force_plot(base_value, shap_values, features=None, feature_names=None, out_names=None, link="identity",
    ...
    if shap_values.shape[0] == 1:
        ...
        return visualize(exps, plot_cmap=plot_cmap, ordering_keys=ordering_keys,
    ...
    if isinstance(e, AdditiveExplanation):
        ...
        if matplotlib:
            ...
            return AdditiveForceArrayVisualizer(e, plot_cmap=plot_cmap, ordering_keys=ordering_keys,
                                                ordering_keys_time_format=ordering_keys_time_format).html()
    else:
